...
# url   https://github.com/AmbientDataInc/LoRa-rssi-measure
...
class LoRa():
    def __init__(self):
        ...
        self.s = serial.Serial('/dev/ttyUSB_DEVICE1', 115200) # シリアルポートを115200kbps, 8bit, Non parity, 1 stop-bitでオープン
